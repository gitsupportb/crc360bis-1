...
export function CountryRiskStressTest() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Stress Test du Risque Pays</CardTitle>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
        ...
        <div className="mt-4 text-sm text-muted-foreground">
          Commentaire: BCP2S ne possède ni créances ni engagements à l'étranger.
        </div>
      </CardContent>
    </Card>
  )
